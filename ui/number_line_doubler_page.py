    ...
    "number_line_doubler": {
        ...
        "teacher_panel": {
            "msvwa": {
                ...
                "sequence": (
                    "The pupil follows the order 2×, 4×, 8× and links each step "
                    "to a doubled product."
                ),
                "variation": "The multiplier and product change; the factor stays fixed.",
                "working_memory": (
                    "Hold the fixed factor, jump sequence, and matching equations together."
                ),
                "attention": (
                    "Notice the fixed factor first, then the doubling in the multiplier "
                    "and product."
                ),
            },
            "diagnostics": {
